(function () {
    ...
    function userCallback(scriptName, data, moduleValues, moduleScripts, moduleNames, callback) {
        if (LOGGING) {
    ...
    function req() {
        ...
        enqueueScriptCompleteCallback(function (err, config) {
            ...
            requestAndPullMany(scriptNames, effectiveConfig, function (err, values) {
                ...
                userCallback(null, callback, values, scriptNames, deps.slice(), function (err, value) {
                    if (err) throw err;
        ...
        enqueueScriptCompleteCallback(function (err, config) {
            ...
            enqueueLoadCallback(scriptName, function () {
                ...
                requestAndPullMany(scriptNames, effectiveConfig, function (err, values) {
                    ...
                    userCallback(scriptName, callback, values, scriptNames, deps.slice(), function (err, value) {
                        if (err) throw err;
