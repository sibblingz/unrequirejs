...
//@}}}
    ...
    function resolveUrl(cwd, baseUrl, path) {
        ...
        } else if (npath[0] === '' || /^[A-Z]:$/i.test(npath[0])) {
        ...
        function def() {
            ...
            enqueueScriptCompleteCallback(function (err, config) {
                ...
                enqueueLoadCallback(scriptName, function () {
                    ...
                    scriptNames.forEach(function(scriptName_) {
                        if(scriptName_ === scriptName) {
                            var msg = "Script " + scriptName + " depends upon itself";
                            if(WARNINGS) {
                                console.error(msg);
                            }
                            throw new Error(msg);
    ...
    (function () {
        ...
        if (ENABLE_SPACEPORT && typeof loadScript === 'function') {
            ...
            var goodResponseCodes = [ 0, 200, 204, 206, 301, 302, 303, 304, 307 ];
            ...
            un = module.exports = create({
                ...
                'loadScriptSync': function (scriptName) {
                    ...
                    require('vm')['runInContext'](code, un['context'] || { }, scriptName);
