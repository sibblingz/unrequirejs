// NOTE: Lines between and including those with @{{{ and @}}} will be removed
    ...
    function execute(deps, config, factory, doneCallback) {
        ...
        load(deps, config, function (errs, values) {
            ...
            if (errorReported) {
                ...
                var value = factory.apply(null, values);
        ...
        api['definePackage'] = function definePackage(rawPackageName, rawModuleNames, config) {
            ...
            map(rawModuleNames, function (rawModuleName) {
                ...
                announce(moduleName, function () {
                    ...
                    // Un-announce the module so we can re-announce it (via the
                    // package).  I consider this a HACK but...
                    var announcedIndex = announced.indexOf(moduleName);
                    announced.splice(announcedIndex, 1);
                    delete announces[moduleName];
